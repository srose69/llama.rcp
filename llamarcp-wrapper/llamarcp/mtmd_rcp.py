...
@ctypes_function(
    "mtmd_init_from_file",
    [c_char_p, llamarcp.llama_model_p_ctypes, mtmd_context_params],
    mtmd_context_p_ctypes,
)
def mtmd_init_from_file(
    mmproj_fname: bytes,
    text_model: llamarcp.llama_model_p,
...
@ctypes_function(
    ...
    [
        mtmd_context_p_ctypes,
        llamarcp.llama_context_p_ctypes,
        mtmd_input_chunk_p_ctypes,
        llamarcp.llama_pos,
        llamarcp.llama_seq_id,
        c_int,
        c_bool,
        POINTER(llamarcp.llama_pos),
    ],
    c_int,
)
def mtmd_helper_eval_chunk_single(
    ctx: mtmd_context_p,
    lctx: llamarcp.llama_context_p,
    chunk: mtmd_input_chunk_p,
    n_past: llamarcp.llama_pos,
    seq_id: llamarcp.llama_seq_id,
    n_batch: Union[c_int, int],
    logits_last: Union[c_bool, bool],
    new_n_past: "_Pointer[llamarcp.llama_pos]",
    /,
) -> int: ...
