...
Then run:
```
uvicorn llamarcp.server.app:create_app --reload
```

or

```
python3 -m llamarcp.server
```
...
from llamarcp.server.app import create_app
...
from llamarcp.server.cli import add_args_from_model, parse_model_from_args
