...
class ModelSettings(BaseSettings):
    ...
    split_mode: int = Field(
        default=llamarcp.LLAMA_SPLIT_MODE_LAYER,
    ...
    use_mmap: bool = Field(
        default=llamarcp.llama_supports_mmap(),
        description="Use mmap.",
    )
    use_mlock: bool = Field(
        default=llamarcp.llama_supports_mlock(),
    ...
    # Context Params
    seed: int = Field(
        default=llamarcp.LLAMA_DEFAULT_SEED, description="Random seed. -1 for random."
    )
