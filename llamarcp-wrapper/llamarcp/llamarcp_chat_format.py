...
# pyright: reportAttributeAccessIssue=false, reportIndexIssue=false, reportArgumentType=false, reportMissingImports=false
...
import llamarcp.llamarcp_wrapper as llama
import llamarcp.llamarcp_types as llama_types
import llamarcp.llamarcp_grammar as llama_grammar
...
class Llava15ChatHandler:
    ...
    def __init__(self, clip_model_path: str, verbose: bool = True):
        import llamarcp.mtmd_cpp as mtmd_cpp
            ...
            try:
                ...
                for i in range(n_chunks):
                    ...
                    if chunk_type == self._mtmd_cpp.MTMD_INPUT_CHUNK_TYPE_TEXT:
                        ...
                        new_n_past = llamarcp.llama_pos(0)
                        result = self._mtmd_cpp.mtmd_helper_eval_chunk_single(
                            self.mtmd_ctx,
                            llama._ctx.ctx,
                            chunk,
                            llamarcp.llama_pos(llama.n_tokens),
                            llamarcp.llama_seq_id(0),
                            llama.n_batch,
                            False,  # logits_last
