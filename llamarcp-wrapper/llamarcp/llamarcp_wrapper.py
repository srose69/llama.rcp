...
LLAMA_SPLIT_MODE_MAX_VALUE = LLAMA_SPLIT_MODE_ROW
...
class llama_model_params(ctypes.Structure):
    ...
    if TYPE_CHECKING:
        ...
        tensor_buft_overrides: CtypesArray[Any]  # NOTE: unused (C struct not bound)
        n_gpu_layers: int
        split_mode: int
        main_gpu: int
...
class llama_context_params(ctypes.Structure):
    ...
    Attributes:
        ...
        n_samplers (int): number of samplers
    """
...
# REMOVED: llama_get_kv_self() - function no longer exists in llama.cpp
# Use llama_get_memory() instead (already implemented above)
...
def llama_flash_attn_type_name(flash_attn_type: Union[ctypes.c_int, int], /) -> bytes:
...
# //
# // KV cache (DEPRECATED - ALL REMOVED from llama.cpp)
# //
# All llama_kv_self_* functions have been REMOVED from llama.cpp
# Use llama_memory_* API instead (implemented in Memory Management section above)
